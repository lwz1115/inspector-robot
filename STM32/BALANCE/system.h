...
typedef struct  
{
	...
	float Motor_Pwm;   //Motor PWM value, control the real-time speed of the motor //电机PWM值，控制电机实时速度
...
/****** 外部变量声明，当其他c文件引用system.h时，也可以使用system.c定义的变量 ******/
extern u8 Flag_Stop;
...
//启动后（1000/100hz=10）秒内不允许控制小车进行运动
...
//机器人型号数量，用于确定Divisor_Mode的值，目前有6种小车类型
#define CAR_NUMBER    6      
#define RATE_1_HZ		  1
#define RATE_5_HZ		  5
