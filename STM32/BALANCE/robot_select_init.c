...
void Robot_Select(void)
{
  ...
  //ADC值分段变化，取决于小车型号数量，目前有6种小车型号，CAR_NUMBER=6
  ...
  if(Car_Mode>5)Car_Mode=5;
	...
	switch(Car_Mode)
	{
		case Mec_Car:       Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     HALL_34F, Photoelectric_500, Mecanum_75);            break; //麦克纳姆轮小车
		case Omni_Car:      Robot_Init(0,                        0,                        Omni_Turn_Radiaus_109, HALL_34F, Photoelectric_500, FullDirecion_60);       break; //全向轮小车
		case Akm_Car:       Robot_Init(Akm_wheelspacing,         Akm_axlespacing,          0,                     HALL_34F, Photoelectric_500, Black_WheelDiameter);   break; //阿克曼小车
		case Diff_Car:      Robot_Init(Diff_wheelSpacing,        0,                        0,                     HALL_34F, Hall_13, Black_WheelDiameter);   break; //差速驱动小车
		case FourWheel_Car: Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     HALL_34F, Photoelectric_500, Black_WheelDiameter);   break; //四驱车 
		case Tank_Car:      Robot_Init(Tank_wheelSpacing,        0,                        0,                     HALL_34F, Photoelectric_500, Tank_WheelDiameter);    break; //坦克车
	}
	...
	switch(Car_Mode)
  {
	 ...
	 case Diff_Car:      CheckPhrase1=4, CheckPhrase2=7;  break; //差速驱动小车
	 case FourWheel_Car: CheckPhrase1=8, CheckPhrase2=11; break; //四驱车 
	 case Tank_Car:      CheckPhrase1=4, CheckPhrase2=7;  break; //坦克车
  }
}
...
Output  : none
功能描述：初始化小车参数
入口参数：轮距 轴距 全向转半径 电机减速比 编码器线数 轮直径
返回  值：无
**************************************************************************/
