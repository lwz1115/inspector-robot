...
void Robot_Select(void)
{
  ...
  if(Car_Mode>5)Car_Mode=5;
	...
	switch(Car_Mode)
	{
		...
		case Diff_Car:      Robot_Init(Diff_wheelSpacing,        0,                        0,                     HALL_34F, Hall_13, Black_WheelDiameter);   break; //两轮差速小车
		...
		case Tank_Car:      Robot_Init(Tank_wheelSpacing,        0,                        0,                     HALL_34F, Photoelectric_500, Tank_WheelDiameter);    break; //履带车
	}
